...
export default class LoadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("leaderboard-btn", "assets/images/leaderboard-btn.png");
        ...
        this.load.image("dev-text", "assets/images/dev-text-bubble.png");
        this.load.spritesheet("flame", "assets/images/flame.png", {frameWidth: 24, frameHeight: 16});
